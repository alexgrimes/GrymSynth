...
describe('ContextManager', () => {
    ...
    describe('Provider-Specific Context Management', () => {
        it('should handle Ollama model context', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('http://localhost:11434/api/generate', expect.objectContaining({
                method: 'POST',
        ...
        it('should handle LM Studio model context', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('http://127.0.0.1:1234/v1/chat/completions', expect.objectContaining({
                method: 'POST',
    ...
    describe('Cross-Provider Context Preservation', () => {
        it('should preserve context when switching between Ollama and LM Studio', async () => {
            ...
            const preserved = await contextManager.preserveContext('deepseek-r1:14b', 'qwen2.5-vl-7b-instruct', messages);
        ...
        it('should handle different context window sizes appropriately', async () => {
            ...
            const state = await contextManager.preserveContext('qwen2.5-vl-7b-instruct', 'deepseek-r1:14b', messages);
    ...
    describe('Theme-based Organization', () => {
        it('should group related messages by theme', async () => {
            ...
            const state = await contextManager.preserveContext('deepseek-r1:14b', 'qwen2.5-vl-7b-instruct', messages);
...
//# sourceMappingURL=test-context-manager.js.map