...
const dynamic_theme_discovery_1 = require("./dynamic-theme-discovery");
async function testThemeDiscovery() {
    // Initialize the theme discovery system
    const themeDiscovery = new dynamic_theme_discovery_1.DynamicThemeDiscovery('llama2');
...
//# sourceMappingURL=test-theme-discovery.js.map