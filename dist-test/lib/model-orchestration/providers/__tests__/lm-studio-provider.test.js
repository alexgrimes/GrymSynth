...
describe('LMStudioProvider', () => {
    ...
    beforeEach(() => {
        provider = new lm_studio_provider_1.LMStudioProvider('test-model', 'Test Model', mockConfig.contextWindow, mockConfig);
    ...
    describe('initialization', () => {
        ...
        it('should initialize with default capabilities for unknown models', () => {
            const unknownProvider = new lm_studio_provider_1.LMStudioProvider('unknown', 'Unknown', 32768, {
                ...mockConfig,
        ...
        it('should override base capabilities with provided ones', () => {
            const customProvider = new lm_studio_provider_1.LMStudioProvider('custom', 'Custom', 32768, {
                ...mockConfig,
                capabilities: {
                    code: 0.95,
                    reasoning: 0.85
    ...
    describe('process', () => {
        ...
        it('should process string input in chat format', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockConfig.endpoint}/v1/chat/completions`, expect.objectContaining({
                method: 'POST',
        ...
        it('should handle API errors gracefully', async () => {
            ...
            await expect(provider.process('test')).rejects.toThrow(types_1.ModelOrchestratorError);
        });
    ...
    describe('testCapability', () => {
        it('should return capability scores for supported capabilities', async () => {
            const result = await provider.testCapability('code');
            expect(result.score).toBeGreaterThan(0);
            expect(result.confidence).toBeGreaterThan(0);
            expect(result.sampleSize).toBeGreaterThan(0);
        });
        it('should return zero scores for unsupported capabilities', async () => {
            const result = await provider.testCapability('unknown');
...
//# sourceMappingURL=lm-studio-provider.test.js.map