...
describe('OllamaProvider', () => {
    ...
    beforeEach(() => {
        provider = new ollama_provider_1.OllamaProvider('test-model', 'Test Model', mockConfig.contextWindow, mockConfig);
    ...
    describe('initialization', () => {
        ...
        it('should initialize with default capabilities for unknown models', () => {
            const unknownProvider = new ollama_provider_1.OllamaProvider('unknown', 'Unknown', 32768, {
                ...mockConfig,
        ...
        it('should override base capabilities with provided ones', () => {
            const customProvider = new ollama_provider_1.OllamaProvider('custom', 'Custom', 32768, {
                ...mockConfig,
                capabilities: {
                    code: 0.95,
                    reasoning: 0.85
    ...
    describe('process', () => {
        ...
        it('should process string input directly', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockConfig.endpoint}/api/generate`, expect.objectContaining({
                method: 'POST',
