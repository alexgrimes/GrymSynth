...
describe('MemoryProfiler', () => {
    ...
    beforeEach(() => {
        profiler = new memory_profile_1.MemoryProfiler(TEST_MEMORY_LIMIT);
    });
    afterEach(() => {
    ...
    describe('Continuous Tracking', () => {
        ...
        it('should detect memory limit violations', async () => {
            const lowMemProfiler = new memory_profile_1.MemoryProfiler(1024); // 1KB limit
...
//# sourceMappingURL=memory-profile.test.js.map