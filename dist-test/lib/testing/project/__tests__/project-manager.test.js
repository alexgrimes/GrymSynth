...
describe('Project Manager Integration', () => {
    ...
    describe('Task Management', () => {
        ...
        it('maintains task context through errors', async () => {
            ...
            const customError = error_test_utils_1.ErrorTestUtils.createErrorWithContext('Task processing error', {
                code: 'TASK_ERROR',
                details: {
                    taskId: 'task_1',
                    modelId: model.id,
            ...
            try {
                ...
                expect(state.metrics.lastError?.details?.taskId).toBe('task_1');
            }
        });
    ...
    describe('Resource Management', () => {
        it('handles concurrent resource requests', async () => {
            ...
            const errors = models.map(model => context.mockError(error_test_utils_1.ErrorTestUtils.createErrorWithContext(`Resource error for ${model.id}`, {
                code: 'RESOURCE_ERROR',
