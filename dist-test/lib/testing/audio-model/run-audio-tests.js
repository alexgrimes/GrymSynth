...
exports.runAudioModelTests = void 0;
const audio_model_test_framework_1 = require("./audio-model-test-framework");
async function runAudioModelTests() {
    ...
    const testFramework = new audio_model_test_framework_1.AudioModelTestFramework(testSuite);
    // Run tests
...
exports.runAudioModelTests = runAudioModelTests;
// Execute tests if run directly
if (require.main === module) {
    runAudioModelTests().catch(console.error);
}
//# sourceMappingURL=run-audio-tests.js.map