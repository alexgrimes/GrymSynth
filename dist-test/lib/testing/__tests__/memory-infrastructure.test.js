...
describe('Memory Testing Infrastructure', () => {
    ...
    let orchestrator;
    beforeEach(() => {
        profiler = new memory_profile_1.MemoryProfiler();
        visualizer = new memory_viz_1.MemoryVisualizer();
        orchestrator = new orchestrator_1.SequentialOrchestrator();
    });
    afterEach(async () => {
    ...
    describe('Memory Profiling', () => {
        ...
        it('should respect memory limits', async () => {
            const testModel = {
                id: 'test-model',
                name: 'Test Model',
                memoryRequirement: 15 * 1024 * 1024 * 1024,
...
//# sourceMappingURL=memory-infrastructure.test.js.map