...
describe('Context Manager', () => {
    ...
    beforeEach(() => {
        contextManager = new context_manager_1.ContextManager(mockConfig);
    });
    ...
    describe('Context Preservation', () => {
        ...
        it('should handle context summarization', async () => {
            ...
            await contextManager.preserveContext('test-model');
            const context = contextManager.getContext('test-model');
            expect(context?.messages.length).toBeLessThanOrEqual(mockConfig.summarizationConfig?.preserveRecentMessages || 5);
        });
    });
