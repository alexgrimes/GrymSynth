...
describe('Context Manager', () => {
    ...
    beforeEach(() => {
        contextManager = new context_manager_1.ContextManager(test_config_1.mockConfig.contextPreservation);
    });
    ...
    describe('Context Preservation', () => {
        ...
        it('should handle context summarization', async () => {
            ...
            await contextManager.preserveContext('test-model');
            const context = contextManager.getContext('test-model');
            expect(context?.messages.length).toBeLessThanOrEqual(test_config_1.mockConfig.contextPreservation.summarizationConfig?.preserveRecentMessages || 5);
        });
    });
    describe('Error Handling', () => {
        it('should handle missing context', async () => {
            ...
            await expect(contextManager.addMessage('non-existent-model', message)).rejects.toThrow('Context not found');
        });
