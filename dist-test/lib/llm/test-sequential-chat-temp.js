...
const multi_provider_chat_1 = require("./multi-provider-chat");
const ollama_provider_1 = require("./providers/ollama-provider");
const lm_studio_provider_1 = require("./providers/lm-studio-provider");
async function testSequentialChat() {
    // Initialize providers with specific models
    const chat = new multi_provider_chat_1.SequentialChat({
        ollama: new ollama_provider_1.OllamaProvider('deepseek-r1:14b'),
        lmStudio: new lm_studio_provider_1.LMStudioProvider('qwen2.5-vl-7b-instruct') // Using the correct Qwen model
    });
    try {
...
//# sourceMappingURL=test-sequential-chat-temp.js.map