...
const recovery_validator_1 = require("../health/recovery-validator");
...
describe('HealthRecoveryValidator State Progression', () => {
    ...
    beforeEach(() => {
        ...
        validator = new recovery_validator_1.HealthRecoveryValidator(config);
        history = {
            transitions: [],
            samples: [],
    ...
    const createHealthyMetrics = () => ({
        responseTime: 100,
        throughput: 1000,
        errorRate: 0.001,
        totalOperations: 10000
    });
    const createDegradedMetrics = () => ({
        responseTime: 200,
        throughput: 800,
        errorRate: 0.05,
        totalOperations: 10000
    });
    const createUnhealthyMetrics = () => ({
        responseTime: 500,
        throughput: 200,
        errorRate: 0.15,
        totalOperations: 10000
    });
    const createHealthState = (status, metrics) => ({
        status,
        indicators: {
            memory: {
                heapUsage: 1000,
    ...
    describe('State Transition Validation', () => {
        it('should allow transition from healthy to degraded', () => {
            ...
            history.getRecentSamples.mockReturnValue(samples);
            const context = {
                currentState,
                history,
...
//# sourceMappingURL=health-monitor-state.test.js.map