...
describe('Learning Profiles System', () => {
    ...
    beforeEach(async () => {
        ...
        try {
            await (0, index_1.deleteProfile)(TEST_MODEL_ID);
        }
        catch (e) {
    ...
    test('initializes a new model profile', async () => {
        const profile = await (0, index_1.initializeProfile)(TEST_MODEL_ID, 'code');
    ...
    test('records learning interactions and updates domain knowledge', async () => {
        await (0, index_1.initializeProfile)(TEST_MODEL_ID, 'code');
        const interaction = {
            topic: 'typescript',
        ...
        const result = await (0, index_1.recordInteraction)(TEST_MODEL_ID, interaction);
    ...
    test('tracks domain mastery progression', async () => {
        ...
        for (let i = 0; i < 10; i++) {
            await (0, index_1.recordInteraction)(TEST_MODEL_ID, {
                topic: 'typescript',
        ...
        const analysis = await (0, index_1.getModelAnalysis)(TEST_MODEL_ID, 'typescript');
    ...
    test('forms cross-domain connections', async () => {
        ...
        const visualization = await (0, index_1.visualizeProfile)(TEST_MODEL_ID);
    ...
    test('adjusts confidence based on success/failure', async () => {
        ...
        let analysis = await (0, index_1.getModelAnalysis)(TEST_MODEL_ID, 'algorithms');
        ...
        analysis = await (0, index_1.getModelAnalysis)(TEST_MODEL_ID, 'algorithms');
    ...
    test('maintains learning timeline', async () => {
        ...
        for (const interaction of interactions) {
            await (0, index_1.recordInteraction)(TEST_MODEL_ID, interaction);
        }
        const visualization = await (0, index_1.visualizeProfile)(TEST_MODEL_ID);
...
//# sourceMappingURL=test-learning-profiles.js.map