...
describe('ImportanceScorer', () => {
    ...
    let scorer;
    beforeEach(() => {
        scorer = new importance_scorer_1.ImportanceScorer(defaultConfig);
        jest.clearAllMocks();
    });
    describe('calculateImportance', () => {
        ...
        it('should handle missing LLM service gracefully', async () => {
            const scorerWithoutLLM = new importance_scorer_1.ImportanceScorer({
                ...defaultConfig,
        ...
        it('should handle missing theme detector gracefully', async () => {
            const scorerWithoutTheme = new importance_scorer_1.ImportanceScorer({
                ...defaultConfig,
...
//# sourceMappingURL=test-importance-scorer.js.map