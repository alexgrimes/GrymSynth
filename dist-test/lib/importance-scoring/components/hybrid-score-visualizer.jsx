...
exports.HybridScoreVisualizer = void 0;
const react_1 = __importDefault(require("react"));
const HybridScoreVisualizer = ({ message, userScore, mlScore, confidence, weight, }) => {
    ...
    return (<div className="space-y-6 p-4 bg-background rounded-lg border">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="h-2 bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-blue-500 rounded-full" style={{ width: userScoreWidth }}/>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="h-2 bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-green-500 rounded-full" style={{ width: mlScoreWidth }}/>
          </div>
        ...
        <div className="space-y-2 pt-4 border-t">
          ...
          <div className="h-3 bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-primary rounded-full" style={{ width: finalScoreWidth }}/>
          </div>
        </div>
      </div>
      ...
      <div className="text-xs text-muted-foreground space-y-1">
        ...
        {message.references && (<p>References: {message.references.length}</p>)}
      </div>
    </div>);
};
exports.HybridScoreVisualizer = HybridScoreVisualizer;
//# sourceMappingURL=hybrid-score-visualizer.jsx.map