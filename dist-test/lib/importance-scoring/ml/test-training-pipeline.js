...
const training_pipeline_1 = require("./training-pipeline");
describe('ImportanceTrainingPipeline', () => {
    let pipeline;
    const inputFeatureSize = 7; // Based on our feature extraction
    beforeEach(() => {
        pipeline = new training_pipeline_1.ImportanceTrainingPipeline(inputFeatureSize);
    });
    const createMockTrainingData = (count) => {
    ...
    describe('model persistence', () => {
        it('should save and load model', async () => {
            ...
            const newPipeline = new training_pipeline_1.ImportanceTrainingPipeline(inputFeatureSize);
...
//# sourceMappingURL=test-training-pipeline.js.map