...
async function createTestAudioFile(index) {
    const audioContext = new standardized_audio_context_1.AudioContext();
            ...
            run: async () => {
                try {
                    ...
                    const conditions = [
                        ...
                        { latency: 100, bandwidth: 1000000, packetLoss: 0.01 },
                        { latency: 500, bandwidth: 100000, packetLoss: 0.05 }
                    ];
...
exports.default = exports.testScenarios;
