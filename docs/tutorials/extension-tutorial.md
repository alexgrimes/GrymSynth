...
This tutorial guides you through extending the GAMA integration in the GrymSynth. You'll learn how to add custom functionality, create plugins, and integrate with other systems to enhance GAMA's capabilities.
...
import { AudioPreprocessor, SimpleAudioBuffer, PreprocessingOptions } from '@GrymSynth/gama-integration';
...
import { GAMAService, SimpleAudioBuffer, ProcessingResult } from '@GrymSynth/gama-integration';
...
import { GAMAService, SimpleAudioBuffer, FeatureExtractor } from '@GrymSynth/gama-integration';
...
import { PatternMatcher, PatternMatch, FeatureVector } from '@GrymSynth/gama-integration';
...
import { RecoveryStrategy, ErrorContext } from '@GrymSynth/gama-integration';
...
import { GAMAService, SimpleAudioBuffer } from '@GrymSynth/gama-integration';
